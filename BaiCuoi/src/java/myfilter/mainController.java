 ...
 * @author ACER
 */
@WebFilter(filterName = "mainController", servletNames = {"totinhServlet"})
public abstract class mainController implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            else if ( !url.contains(".jsp") && !url.contains(".html"))
            {
                url = url + "Servlet";
            }
